...
abstract class BaseTournamentFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'inscription_price'               => new sfWidgetFormFilterInput(),
      ...
      'subtournament_inscription_price' => new sfWidgetFormFilterInput(),
    ...
    $this->setValidators(array(
      ...
      'inscription_price'               => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
      ...
      'subtournament_inscription_price' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
  ...
  public function getFields()
  {
    return array(
      ...
      'subtournament_inscription_price' => 'Number',
