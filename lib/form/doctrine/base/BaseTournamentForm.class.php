...
abstract class BaseTournamentForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'inscription_price'               => new sfWidgetFormInputText(),
      ...
      'subtournament_inscription_price' => new sfWidgetFormInputText(),
    ...
    $this->setValidators(array(
      ...
      'inscription_price'               => new sfValidatorInteger(array('required' => false)),
      ...
      'subtournament_inscription_price' => new sfValidatorInteger(array('required' => false)),
